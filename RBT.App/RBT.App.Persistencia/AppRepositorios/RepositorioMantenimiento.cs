...
namespace RBT.App.Persistencia
{
    public class RepositorioMantenimiento:IRepositorioMantenimiento
    {
        ...
        {// el simbolo "=>" quiere decir donde. La letra "m" hace referencia a la tabla mantenimientos.
            var mantenimientoEncontrado= _appContext.Mantenimientos.FirstOrDefault(m =>m.Id==mantenimiento.Id); // No estoy seguro de que sea "Mantenimiento.Id"
